    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">
                            <a href="{{route('admin.'.$route)}}" class="text-muted text-hover-primary">الاقسام</a>
                        </li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            ...
            <div id="kt_content_container" class="container-xxl">
                <!--begin::Form-->
                <form action="{{route('admin.'.$route.'.update')}}" method="post" enctype="multipart/form-data" class="form d-flex flex-column flex-lg-row gap-7 gap-lg-10" >
                @csrf
                                    ...
                                    <div class="card card-flush py-4">
                                        ...
                                        <div class="card-body pt-0">
                                            <div class="mb-10 fv-row">
                                                ...
                                                <input type="text" required name="title_ar" value="{{$row->title_ar}}" class="form-control mb-2" />
                                            </div>
                                            <div class="mb-10 fv-row">
                                                <label class="required form-label">اسم القسم بالانجليزية</label>
                                                <input type="text" required name="title_en" value="{{$row->title_en}}" class="form-control mb-2" />
                                            </div>
                                            <div class="mb-10 fv-row">
                                                <label class="required form-label">وصف قصير للقسم بالعربية</label>
                                                <textarea required name="body_ar" class="form-control mb-2" >{{$row->body_ar}}</textarea>
                                            </div>
                                            <div class="mb-10 fv-row">
                                                <label class="required form-label">وصف قصير للقسم بالانجليزية</label>
                                                <textarea  required name="body_en"  class="form-control mb-2" >{{$row->body_en}}</textarea>
                                            </div>
                                        </div>
                                        <!--end::Card header-->
                                    </div>
