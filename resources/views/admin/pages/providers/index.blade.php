...
{{--                                </th>--}}
                                ...
                                <th class=" min-w-100px">رخصة القيادة</th>
    ...
    <script>
        $(document).ready(function () {
            ...
            $("#slider_table").DataTable({
                    ...
                    },
                    {
                        ...
                        customize: function (win) {
                            $(win.document.body)
                                ...
                                '                                    <td style="text-align: right"><p>عنوان التقرير : مقدمي الخدمات</p>' +
                ...
                ajax: '{{ route('admin.providers.datatable') }}',
                "columns": [
                    {data: 'DT_RowIndex', name: 'DT_RowIndex', "searchable": false, "orderable": false},
                    {"data": "name", "searchable": false, "orderable": false},
                    {"data": "phone", "searchable": true, "orderable": false},
                    {"data": "drive_licence", "searchable": true, "orderable": false},
