                    ...
                    <div class="card-body pt-0">
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="orders_table">
                            ...
                            <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                ...
                                <th class=" min-w-10px">مقدم الخدمة</th>
...
@section('script')
        ...
        $(document).ready(function () {
            ...
            $("#orders_table").DataTable({
                ...
                "columns": [
                    ...
                    {"data": "total_cost", "searchable": true, "orderable": true},
                    {"data": "selected_status", "searchable": false, "orderable": false},
    ...
    <script>
        ...
        $("#orders_table").find('.group-checkable').change(function () {
        ...
        $("#orders_table").on('change', 'tbody tr .checkboxes', function () {
    ...
    <script>
        ...
        $bulkDeleteBtn.click(function (e) {
            var $checkedBoxes = $('#orders_table input[type=checkbox]:checked').not('.select_all');
