        ...
        <div class="toolbar" id="kt_toolbar">
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div class="d-flex align-items-center py-1">
                    ...
                    <!--end::Wrapper-->
                    <!--begin::Button-->
                    <a href="{{route('admin.car-categories.create')}}" class="btn btn-sm btn-success">
    ...
    <script>
        $(document).ready(function () {
            ...
            $("#slider_table").DataTable({
                    ...
                    },
                    {
                        ...
                        customize: function (win) {
                            $(win.document.body)
                                ...
                                '                                    <td style="text-align: right"><p>عنوان التقرير : انواع السيارات</p>' +
                ...
                ajax: '{{ route('admin.car-categories.datatable') }}',
                "columns": [
        ...
        $(document).on("click", ".delete", function () {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        url: '{{route('admin.car-categories.delete')}}',
                        type: "post",
