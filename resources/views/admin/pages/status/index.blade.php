        ...
        <div class="toolbar" id="kt_toolbar">
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div class="d-flex align-items-center py-1">
                    ...
                    <!--end::Wrapper-->
                    <!--begin::Button-->
                    <a href="{{route('admin.status.create')}}" class="btn btn-sm btn-success">
                    ...
                    <div class="card-body pt-0">
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="slider_table">
                            ...
                            <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                ...
                                <th class=" min-w-10px">key</th>
                                <th class=" w-200px">العنوان (بالعربي)</th>
                                <th class=" w-200px">العنوان (بالانجليزي)</th>
                                <th class=" w-200px">خاص بتطبيق ؟</th>
    ...
    <script>
        $(document).ready(function () {
            ...
            $("#slider_table").DataTable({
                    ...
                    },
                    {
                        ...
                        customize: function (win) {
                            $(win.document.body)
                                ...
                                '                                    <td style="text-align: right"><p>عنوان التقرير : الحالات</p>' +
                ...
                ajax: '{{ route('admin.status.datatable') }}',
                "columns": [
                    {data: 'DT_RowIndex', name: 'DT_RowIndex', "searchable": false, "orderable": true},
                    {"data": "active", "searchable": false, "orderable": false},
                    {"data": "key", "searchable": true, "orderable": true},
                    {"data": "title_ar", "searchable": true, "orderable": true},
                    {"data": "title_en", "searchable": true, "orderable": true},
                    {"data": "appear_in_app", "searchable": true, "orderable": true},
