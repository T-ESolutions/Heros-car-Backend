                                        ...
                                        <div class="card-body pt-0">
                                            ...
                                            <div class="mb-10 fv-row">
                                                ...
                                                <input type="text" required name="title_ar" class="form-control mb-2"
                                                       placeholder="عنوان النوع (بالعربي)" value="{{$row->title_ar}}"/>
                                                <!--end::Input-->
                                                <!--begin::Description-->
                                            {{--                                                <div class="text-muted fs-7">A product name is required and recommended to be unique.</div>--}}
                                            <!--end::Description-->
                                            ...
                                            <div class="mb-10 fv-row">
                                                ...
                                                <select required class="form-control mb-2" name="appear_in_app"
                                                    ...
                                                    <option @if($row->appear_in_app == "user") selected
                                                            @endif value="user">تطبيق العميل
                                                    </option>
                                                    <option @if($row->appear_in_app == "provider") selected
                                                            @endif value="provider">تطبيق مقدم الخدمة
                                                    </option>
                                                    <option @if($row->appear_in_app == "admin") selected
                                                            @endif value="admin">الادمن
                                                    </option>
                                                    <option @if($row->appear_in_app == "other") selected
                                                            @endif value="other">أخرى
                                                    </option>
