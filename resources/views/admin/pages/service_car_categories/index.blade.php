        ...
        <div class="toolbar" id="kt_toolbar">
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div class="d-flex align-items-center py-1">
                    ...
                    <!--end::Wrapper-->
                    <!--begin::Button-->
                    <a href="{{route('admin.service-car-categories.create')}}" class="btn btn-sm btn-success">
                    ...
                    <div class="card-body pt-0">
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="slider_table">
                            ...
                            <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                ...
                                <th class=" min-w-10px">السعر</th>
                                <th class=" min-w-10px">السعر/كم</th>
                                <th class=" min-w-10px">الكم المجاني</th>
                                <th class=" min-w-10px">الضريبة</th>
                                <th class=" min-w-10px"> الخدمة </th>
                                <th class=" min-w-10px">نوع السيارة</th>
                                <th class=" min-w-10px">البراند</th>
                                <th class=" min-w-10px">الموديل</th>
                                <th class=" min-w-10px">سنه الصنع</th>
    ...
    <script>
        $(document).ready(function () {
            ...
            $("#slider_table").DataTable({
                    ...
                    },
                    {
                        ...
                        customize: function (win) {
                            $(win.document.body)
                                ...
                                '                        <tbody> ' +
                                '                                <tr>' +
                                '                                    <td style="text-align: center">  <p style="padding-right:150px">Winch Out</p></td>' +
                                '                                    <td style="text-align: right"> <img src="{{asset('default.png')}}" width="150px" height="150px" /> </td>' +
                                '                                    <td style="text-align: right"><p>عنوان التقرير : خدمات انواع السيارات</p>' +
                ...
                ajax: '{{ route('admin.service-car-categories.datatable') }}',
                "columns": [
                    {data: 'DT_RowIndex', name: 'DT_RowIndex', "searchable": false, "orderable": true},

                    {"data": "price", "searchable": true, "orderable": true},
                    {"data": "price_km", "searchable": true, "orderable": true},
                    {"data": "free_km", "searchable": true, "orderable": true},
                    {"data": "vat", "searchable": true, "orderable": true},
                    {"data": "service", "searchable": true, "orderable": true},
                    {"data": "car_category", "searchable": true, "orderable": true},
                    {"data": "brand", "searchable": true, "orderable": true},
                    {"data": "modell", "searchable": true, "orderable": true},
        ...
        $(document).on("click", ".delete", function () {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        url: '{{route('admin.service-car-categories.delete')}}',
                        type: "post",
