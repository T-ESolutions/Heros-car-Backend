    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            ...
            <div id="kt_content_container" class="container-xxl">
                <!--begin::Form-->
                <form action="{{route('admin.service-car-categories.store')}}" method="post"
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                ...
                                <input type="number" required name="price_km" class="form-control mb-2"
                                       placeholder="السعر لكل كم" value="{{old('price_km')}}"/>
                                </select>
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                ...
                                <input type="number" required name="free_km" class="form-control mb-2"
                                       placeholder="المسافة المجانيه باكم" value="{{old('free_km')}}"/>
                                </select>
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                ...
                                <input type="number" required name="vat" class="form-control mb-2"
                                       placeholder="الضريبة" value="{{old('vat')}}"/>
                                </select>
