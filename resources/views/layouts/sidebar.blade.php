...
<div id="kt_aside" class="aside aside-dark aside-hoverable" data-kt-drawer="true" data-kt-drawer-name="aside"
    ...
    <!--begin::Brand-->
    <div class="aside-logo flex-column-auto " id="kt_aside_logo" style="background-color: white;height: 115px">
        <!--begin::Logo-->
        <a href="{{asset('/')}}">
            <img alt="Logo" src="{{asset('/')}}/default2.png" class="h-150px logo p-5"
    ...
    <div class="aside-menu flex-column-fluid">
        ...
        <div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true"
            ...
            <div
                ...
                <div class="menu-item">
                    <a class="menu-link @if(request()->segment(2) == 'providers' ) active @endif"
                       href="{{route('admin.providers')}}">
                        ...
                        <span class="menu-title">مقدمين الخدمة</span>
                    </a>
                </div>

                <div class="menu-item">
                    <a class="menu-link @if(request()->segment(2) == 'orders' ) active @endif"
...
<path
    ...
    fill="black"/>
                ...
                <div class="menu-item">
                    <a class="menu-link @if(request()->segment(2) == 'modells') active @endif"
                       href="{{route('admin.modells')}}">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/art/art002.svg-->
                            <!--begin::Svg Icon | path: assets/media/icons/duotune/abstract/abs035.svg-->
                                <span class="svg-icon svg-icon-muted svg-icon-2hx">
                        ...
                        <span class="menu-title">اعدادات الموديلات</span>
                    </a>
                </div>
                <div class="menu-item">
                    <a class="menu-link @if(request()->segment(2) == 'car-categories') active @endif"
                       href="{{route('admin.car-categories')}}">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/art/art002.svg-->
                            <!--begin::Svg Icon | path: assets/media/icons/duotune/abstract/abs035.svg-->
                                <span class="svg-icon svg-icon-muted svg-icon-2hx">
                        ...
                        <span class="menu-title">اعدادات السيارات</span>
                    </a>
                </div>
                <div class="menu-item">
                    <a class="menu-link @if(request()->segment(2) == 'service-car-categories') active @endif"
                       href="{{route('admin.service-car-categories')}}">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/art/art002.svg-->
                            <!--begin::Svg Icon | path: assets/media/icons/duotune/abstract/abs035.svg-->
                                <span class="svg-icon svg-icon-muted svg-icon-2hx">
                        ...
                        <span class="menu-title">اعدادات خدمات انواع السيارات</span>
                    </a>
                </div>
                <div class="menu-item">
                    <a class="menu-link @if(request()->segment(2) == 'status') active @endif"
                       href="{{route('admin.status')}}">
                        ...
                        <span class="menu-title">اعدادات الحالات</span>
                    </a>
                </div>
                <div class="menu-item">
                    <a class="menu-link @if(request()->segment(2) == 'cancel-reasons') active @endif"
                       href="{{route('admin.cancel-reasons')}}">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/art/art002.svg-->
                            <!--begin::Svg Icon | path: assets/media/icons/duotune/abstract/abs035.svg-->
                                <span class="svg-icon svg-icon-muted svg-icon-2hx">
                        ...
                        <span class="menu-title">اعدادات اسباب الرفض</span>
                    </a>
                </div>
                <div class="menu-item">
