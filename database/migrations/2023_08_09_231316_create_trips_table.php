...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('trips', function (Blueprint $table) {
            ...
            $table->time('trip_time_from')->nullable();
            $table->time('trip_time_to')->nullable();
            ...
            $table->text('from_address_ar')->nullable();
            $table->text('from_address_en')->nullable();
            $table->string('to_lat')->nullable();
            $table->string('to_lng')->nullable();
            $table->text('to_address_ar')->nullable();
            $table->text('to_address_en')->nullable();
