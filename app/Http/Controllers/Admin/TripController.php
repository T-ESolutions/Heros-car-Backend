...
class TripController extends Controller
{
    ...
    {
        return view('admin.pages.trips.index');
    }
    ...
    public function getData()
    {
        ...
        return DataTables::eloquent($model)
            ...
            ->addColumn('actions', function ($row) use ($auth) {
                $buttons = '';
                $buttons .= '<a href="' . route('admin.trips.details', [$row->id]) . '" class="btn btn-warning btn-circle btn-sm m-1" title="عرض بيانات الطلب">
                            <i class="fa fa-eye"></i>
                        </a>';
    ...
    public function details($id)
    {
        ...
        return view('admin.pages.trips.details', compact('row'));
    }
