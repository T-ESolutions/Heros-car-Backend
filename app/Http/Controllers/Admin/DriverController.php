...
class DriverController extends Controller
{
    ...
    public function edit($id)
    {
        ...
        return view('admin.pages.drivers.edit',compact('row'));
    }
...
//                if ($auth->can('sliders.update')) {
                    $buttons .= '<a href="'.route('admin.drivers.edit',[$row->id]).'" class="btn btn-primary btn-circle btn-sm m-1" title="تعديل">
                            <i class="fa fa-edit"></i>
                        </a>';
//                }
//                if ($auth->can('sliders.delete')) {
                    $buttons .= '<a href="'.route('admin.drivers.orders',[$row->id]).'" class="btn btn-warning btn-sm btn-circle m-1" title="الطلبات">
...
//                }
    ...
    public function userOrders($user_id)
    {
        ...
        return view('admin.pages.drivers.orders',compact('user_id','user_name'));
    }

    public function getDriverOrdersData($user_id)
    {
        $auth = Auth::guard('admin')->user();
